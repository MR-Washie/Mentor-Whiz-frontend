    ...
    <section className="w-full bg-white py-10 px-4 md:px-16 relative overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left relative z-10">
          ...
          <h2 className="text-2xl md:text-3xl font-semibold mb-4">Job Hiring</h2>

          <p className="text-gray-600 mb-4">
            We help teams hire better and faster—role scoping, scorecards, structured interviews,
            and hands‑on support with sourcing and shortlisting.
          </p>

          <p className="text-gray-600 mb-6">
            For candidates, get tailored prep: resume targeting, project storytelling, mock interviews,
            and offer negotiation. For companies, expect curated pipelines and interview alignment.
          </p>
      ...
      <div className="hidden md:block absolute bottom-0 right-0 z-0">
        <div className="w-40 h-40 bg-purple-600 rounded-full translate-x-1/2 translate-y-1/2"></div>
      </div>
    </section>
  );
}
